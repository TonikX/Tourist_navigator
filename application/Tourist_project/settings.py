...
DJOSER = {
    ...
    'SERIALIZERS': {
        #'user': 'Tourist_app.serializers.UserSerializer',
        #'current_user': 'Tourist_app.serializers.UserSerializer',
        #'user_create': 'Tourist_app.serializers.UserSerializer',
    },
}